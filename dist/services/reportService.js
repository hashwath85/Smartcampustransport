...
export async function getFleetPerformanceReport(filters = {}) {
    ...
    return {
        ...
        metrics: {
            ...
            activeBuses,
            idleBuses,
            fleetUtilizationRate: totalBuses > 0
...
export async function getBreakdownAnalyticsReport(filters = {}) {
...
export async function getComplaintsAnalyticsReport(filters = {}) {
